...
mapboxgl.accessToken = 'pk.eyJ1Ijoiam1yaW5jb25yIiwiYSI6ImNtaHNtZ2xhazFtYjkya3E0NjcwbjV6OG8ifQ.VjWea3wTJMl1A2mmfgtEnQ';
...
map.on('load', async () => {
    ...
    map.addSource('cambridge_route', {
        type: 'geojson',
        data: 'data/Cambridge_BikeFacilities.geojson',
    });
